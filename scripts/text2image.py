...
if __name__ == "__main__":
    ...
    args.prompt = f"Consistency quality evaluate how smoothly the object region integrates with its surroundings in terms of color, texture, and illumination, ensuring visual seamlessness. Generate an image: {args.prompt}"
